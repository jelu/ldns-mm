...
#undef __LDNS_RDF_DATA_IN_PTR
#undef __LDNS_RDF_SIZE_TRACKING

#ifdef __LDNS_RDF_DATA_IN_PTR
#define LDNS_RDF_DATA_NUM 1
#define LDNS_RDF_DATA_SIZE (sizeof(void *)*LDNS_RDF_DATA_NUM)
#endif
...
struct ldns_struct_rdf_minfo {
	unsigned long num[32];
};
typedef struct ldns_struct_rdf_minfo ldns_rdf_minfo;
extern ldns_rdf_minfo _ldns_rdf_minfo;
#endif
