...
#undef __LDNS_RR_NEW_WITHOUT_ALLOC
		             ...
		             ldns_rdf **prev, bool question)
{
	...
	uint32_t ttl_val;
#ifndef __LDNS_RR_NEW_WITHOUT_ALLOC
	char  *owner = NULL;
	char  *ttl = NULL;
#endif
...
#ifdef __LDNS_RR_NEW_WITHOUT_ALLOC
	char owner[LDNS_MAX_DOMAINLEN + 1];
	char ttl[LDNS_TTL_DATALEN];
#endif
...
#ifdef __LDNS_RR_NEW_WITHOUT_ALLOC
	if (!new || !clas || !rdata || !rr_buf || !rd_buf || !rd || !b64 ) {
#else
